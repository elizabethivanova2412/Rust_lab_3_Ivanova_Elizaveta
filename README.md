...
```
=== БИБЛИОТЕКА УНИВЕРСИТЕТА 2025 ===
Система управления книжным фондом
...
--- ДОБАВЛЕНИЕ НОВОЙ КНИГИ ---
Название книги: Программирование на Rust
Автор книги: Кэрол Николс
Книга 'Программирование на Rust' (автор: Кэрол Николс) добавлена. ID: 1

[Техническая информация]
   Адрес объекта в памяти: 0x7ffd8c3a1b40

Выберите действие: 2

--- РЕГИСТРАЦИЯ НОВОГО ЧИТАТЕЛЯ ---
Имя читателя: Петров Сергей
Читатель 'Петров Сергей' зарегистрирован. ID: 1
...
├─────┼────────────────────────────┼──────────────────────┼──────────┤
│   1 │ Программирование на Rust   │ Кэрол Николс         │ Доступна  │
└─────┴────────────────────────────┴──────────────────────┴──────────┘
...
│ ID  │ Название                   │ Автор                │ Статус    │
├─────┼────────────────────────────┼──────────────────────┼──────────┤
│   1 │ Программирование на Rust   │ Кэрол Николс         │ Выдана    │
└─────┴────────────────────────────┴──────────────────────┴──────────┘
...
Данные успешно сохранены в 'library_data.json'.
До свидания!
```
